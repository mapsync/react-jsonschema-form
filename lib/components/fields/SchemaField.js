...
function Label(props) {
  ...
  return _react2.default.createElement(
    "label",
    { className: "form-label d-inline-block", htmlFor: id },
    label,
...
function ErrorList(props) {
  ...
  return _react2.default.createElement(
    "span",
    { className: "chip text-center tooltip tooltip-right bg-error ml-1 pt-1 float-right", "data-tooltip": errors.join('\n') },
...
function SchemaFieldRender(props) {
  ...
  var altArray = (0, _utils.isMultiSelect)(schema, definitions) || (0, _utils.isFilesArray)(schema, uiSchema, definitions);
  if (altArray) {
    displayLabel = true;
